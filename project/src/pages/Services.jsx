...
const Services = () => {
  ...
  const ServiceCard = ({ service, index }) => {
    ...
    const colorClasses = {
      blue: 'from-blue-600 to-blue-700 border-blue-100',
      cyan: 'from-cyan-600 to-cyan-700 border-cyan-100',
      green: 'from-green-600 to-green-700 border-green-100',
      orange: 'from-orange-600 to-orange-700 border-orange-100',
      indigo: 'from-indigo-600 to-indigo-700 border-indigo-100',
      teal: 'from-teal-600 to-teal-700 border-teal-100'
    };
    ...
    return (
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden group relative"
      >
          ...
          {hoveredCard === index && (
            <>
              ...
              <motion.div
                ...
                className="absolute bottom-4 left-4 w-1.5 h-1.5 bg-cyan-500 rounded-full"
              />
            </>
          )}
        </AnimatePresence>
        ...
        <div className="p-8 relative z-10">
          {/* Animated Icon */}
          <motion.div
            className={`w-14 h-14 rounded-2xl bg-gradient-to-r ${colorClasses[service.color]} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 relative overflow-hidden`}
            whileHover={{
              rotate: [0, -5, 5, 0],
              scale: 1.15,
              transition: { duration: 0.5 }
        ...
        <div className="px-8 pb-8 relative z-10">
          <motion.button
            ...
            className="w-full bg-gray-900 text-white py-3 px-6 rounded-xl font-semibold hover:bg-gray-800 transition-colors duration-300 flex items-center justify-center group/btn relative overflow-hidden"
            whileHover={{
              scale: 1.02,
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-white relative overflow-hidden">
        ...
        >
          <motion.div
            ...
            className="absolute top-10 left-10 w-72 h-72 bg-blue-200 rounded-full blur-3xl opacity-20"
          />
          <motion.div
            animate={{
              scale: [1.2, 1, 1.2],
            ...
            className="absolute bottom-10 right-10 w-96 h-96 bg-cyan-200 rounded-full blur-3xl opacity-20"
          />
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {/* Fixed Animated Badge with Floating Effect */}
            <motion.div
          ...
          {/* Enhanced Stats with Improved Animations */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{
